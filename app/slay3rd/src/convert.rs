...
pub(crate) fn duration_from_proto(
    ...
    slay3r_std::Duration::from_parts(proto.seconds as u64, proto.nanos as u64)
}

pub(crate) fn duration_to_proto(
    std: slay3r_std::Duration,
...
) -> slay3r_std::api::ConsensusParams {
    slay3r_std::api::ConsensusParams {
...
pub(crate) fn consensus_params_to_proto(
    std: slay3r_std::api::ConsensusParams,
...
pub(crate) fn block_params_to_proto(
    std: slay3r_std::api::BlockParams,
...
pub(crate) fn evidence_params_to_proto(
    std: slay3r_std::api::EvidenceParams,
...
) -> Vec<slay3r_std::api::ValidatorUpdate> {
...
) -> slay3r_std::api::ValidatorUpdate {
    slay3r_std::api::ValidatorUpdate {
...
pub(crate) fn validator_updates_to_proto(
    std: Vec<slay3r_std::api::ValidatorUpdate>,
...
pub(crate) fn validator_update_to_proto(
    std: slay3r_std::api::ValidatorUpdate,
