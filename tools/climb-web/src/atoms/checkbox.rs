...
impl Checkbox {
    ...
    pub fn with_selected_signal(mut self, selected_signal: impl Signal<Item = bool> + 'static) -> Self {
    ...
    pub fn render(self) -> Dom {
        ...
        let Self { selected_signal, label, on_click } = self;
