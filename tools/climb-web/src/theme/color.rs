...
impl Color {
    ...
    pub fn class(&self) -> &str {
        pub static DARKEST:LazyLock<String> = LazyLock::new(|| class! {
            .style("color", Color::Darkest.hex_str())
        });

        pub static ACCENT:LazyLock<String> = LazyLock::new(|| class! {
            .style("color", Color::Accent.hex_str())
        });

        pub static ACCENT_DARKER:LazyLock<String> = LazyLock::new(|| class! {
            .style("color", Color::AccentDarker.hex_str())
        });

        pub static WHITEISH:LazyLock<String> = LazyLock::new(|| class! {
            .style("color", Color::Whiteish.hex_str())
        });

        pub static DARKISH:LazyLock<String> = LazyLock::new(|| class! {
            .style("color", Color::Darkish.hex_str())
        });

        pub static GREY:LazyLock<String> = LazyLock::new(|| class! {
            .style("color", Color::Grey.hex_str())
        });

        pub static GREY_ALT1:LazyLock<String> = LazyLock::new(|| class! {
            .style("color", Color::GreyAlt1.hex_str())
        });

        pub static GREY_ALT2:LazyLock<String> = LazyLock::new(|| class! {
            .style("color", Color::GreyAlt2.hex_str())
        });

        pub static FOCUS:LazyLock<String> = LazyLock::new(|| class! {
            .style("color", Color::Focus.hex_str())
        });

        pub static RED:LazyLock<String> = LazyLock::new(|| class! {
            .style("color", Color::Red.hex_str())
        });

        pub static RED_DARKER:LazyLock<String> = LazyLock::new(|| class! {
            .style("color", Color::RedDarker.hex_str())
        });

        pub static ORANGE:LazyLock<String> = LazyLock::new(|| class! {
            .style("color", Color::Orange.hex_str())
        });

        pub static ORANGE_DARKER:LazyLock<String> = LazyLock::new(|| class! {
            .style("color", Color::OrangeDarker.hex_str())
        });

        pub static GREEN:LazyLock<String> = LazyLock::new(|| class! {
            .style("color", Color::Green.hex_str())
        });

        pub static GREEN_DARKER:LazyLock<String> = LazyLock::new(|| class! {
            .style("color", Color::GreenDarker.hex_str())
        });

        pub static PURE_WHITE:LazyLock<String> = LazyLock::new(|| class! {
