...
Check out [avs-toolkit](https://github.com/Lay3rLabs/avs-toolkit) and go into `tools/cli` dir.
More info available on the [README there](https://github.com/Lay3rLabs/avs-toolkit/blob/main/tools/cli/README.md).
